...
// Lab #7, node
//
// File 3/7: Other files: company.h company.cpp database.h main.cpp node.cpp node.h
// FILE: database.cpp
...
namespace coen79_lab7
{
    ...
    void database::reserve(size_type new_capacity)
    {
        ...
        company *dummy = new company[new_capacity];
        std::copy(company_array, company_array + used_slots, dummy);
        delete[] company_array;
