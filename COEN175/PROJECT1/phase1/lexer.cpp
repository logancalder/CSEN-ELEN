        ...
        else if (operators.find(c) != operators.end())
        {
            ...
            if (next_c != EOF)
            {
                ...
                if (next_next_c != EOF)
                {
                    ...
                    {
                        ungetc(next_next_c, stdin); // Put back the third character
                    }
                }
                else
                {
                    ungetc(next_next_c, stdin); // Put back EOF
                }
            }
            ...
            if (next_c != EOF)
            {
                ...
                {
                    ungetc(next_c, stdin); // Put back the character if it's not part of a two-char operator
                }
            }
