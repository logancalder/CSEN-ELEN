...
// Script implements functions to utilize hash table chaining. Removes a search function and instead uses list.c findItem and other
// list.c functions. This script also uses memcpy in getElements instead of a nested loop to return the array of elements.
